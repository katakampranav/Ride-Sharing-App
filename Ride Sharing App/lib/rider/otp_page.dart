...
import 'package:my_app/rider/follow_up_page.dart';
...
class _OTPPageState extends State<OTPPage> {
  ...
  Widget _buildOTPDisplaySection() {
    return Container(
      decoration: BoxDecoration(
      ...
      child: Column(
        ...
        children: [
          ...
          // OTP Display Boxes (Static, not for input)
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: ["7", "4", "3", "2"].map((digit) {
              return Container(
                width: 50,
                height: 50,
