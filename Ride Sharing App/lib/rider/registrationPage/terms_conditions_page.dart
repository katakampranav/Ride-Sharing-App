...
import 'package:my_app/rider/registrationPage/location_details_page.dart';
...
class _TermsConditionsPageState extends State<TermsConditionsPage> {
  ...
  bool get _allAccepted =>
      _acceptedTerms && _acceptedPrivacy && _acceptedCommunityGuidelines;

  void _onFinish() {
    if (_allAccepted) {
      Navigator.of(context).pushAndRemoveUntil(
        MaterialPageRoute(builder: (context) => const LocationDetailsPage()),
        (route) => false,
      );
    }
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildAgreementItem(
                    ...
                    content:
                        'By using our ride-sharing service, you agree to follow our community guidelines, respect other users, and maintain a safe environment for everyone.',
                  ...
                  _buildAgreementItem(
                    ...
                    content:
                        'We collect and use your location, payment, and profile information to provide our services. Your data is protected and will not be shared without your consent.',
                  ...
                  _buildAgreementItem(
                    ...
                    content:
                        'Be respectful to drivers and fellow riders. No smoking, alcohol, or inappropriate behavior. Keep the vehicle clean and follow safety instructions.',
